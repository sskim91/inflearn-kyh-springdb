...
class MemberServiceV3_3Test {
    ...
    void AopCheck() throws Exception {
        ...
        boolean memberRepositoryProxy = AopUtils.isAopProxy(memberRepository);
        boolean memberServiceProxy = AopUtils.isAopProxy(memberService);
        assertThat(memberRepositoryProxy).isFalse();
        assertThat(memberServiceProxy).isTrue();
